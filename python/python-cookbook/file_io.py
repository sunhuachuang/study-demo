...
# ['test.php', 'phpMyAdmin-4.6.0-all-languages', 'symfony3', 'symfony2', 'laravel', 'learn']
print(os.listdir('../../../php'))
phps = [name for name in os.listdir('../../../php') if name.endswith('.php')]
print(phps)  # ['test.php']

files = [name for name in os.listdir(
    '../../../php') if os.path.isfile(os.path.join('../../../php', name))]
...
# 1462503183.2089999->Fri May  6 10:53:03 2016
...
# ('/home/sun/tmp/test.py', '.txt')
print(os.path.splitext('/home/sun/tmp/test.py.txt'))
# /home/sun/workspace/python/study/python-study/test.py
