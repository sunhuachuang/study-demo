...
dataObject = json.loads(data, object_hook=Person) #object_hook object_pairs_hook
...
def unserialize_object(d):
    ...
    if clsname:
        ...
        return d
print(json.loads(d, object_hook=unserialize_object)) #<__main__.Point object at 0x7fdfa3faea20>
...
with open('tmp/test.csv') as f:
    ...
    for r in f_csv:
        print(Row(*r)) #Row(Symbol='AA', Price='39.48', Date='6/11/2007', Time='9:36am', Change='-0.18', Volume='181800') ...

with open('tmp/test.csv') as f:
    f_csv = csv.DictReader(f)
    for row in f_csv:
        print(row) #{'Symbol': 'AA', 'Date': '6/11/2007', 'Change': '-0.18', 'Volume': '181800', 'Time': '9:36am', 'Price': '39.48'} ..
