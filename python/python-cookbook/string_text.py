...
print('my name is {name}, age is {age}'.format(
    name=name, age=age))  # my name is sun, age is 24
print('my name is {name}, age is {age}'.format_map(
    vars()))  # my name is sun, age is 24
...
a = Info('huachuang', 24)
print('my name is {name}, age is {age}'.format_map(
    vars(a)))  # my name is huachuang, age is 24
