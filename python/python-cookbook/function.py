...
apply_async(add, ('hello', ', world!'), callback=handler2.send) #[2]: hello, world!
...
def avg(a:int, b:int) -> float:
    return (a+b)/2
print(avg(1, 2)) #1.5
print(avg.__annotations__) #{'a': <class 'int'>, 'return': <class 'float'>, 'b': <class 'int'>}
...
def make_element(name, value, **attrs):
    ...
    return element
print(make_element('div', 'this is div', ides='eid', classes='eclass')) #<div classes="eclass" ides="eid">this is div</div>
print(make_element('p', '<span>p</span>', names='ep')) #<p names="ep">&lt;span&gt;p&lt;/span&gt;</p>
