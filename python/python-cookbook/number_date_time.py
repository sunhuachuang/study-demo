...
print(a.imag)  # 4.0
print(a.conjugate)
# 0.0 4.0 <built-in method conjugate of complex object at 0x7f361fd902f0>
...
# b'\x00\x00\x00\x00\x00\x00K\x03\xad\xbc\x0f6H\x98\xf3\xb9' big and little 高低位顺序
print(num.to_bytes(16, 'big'))
# b'\xb9\xf3\x98H6\x0f\xbc\xad\x03K\x00\x00\x00\x00\x00\x00'
print(num.to_bytes(16, 'little'))
# 354245345345234523452345
print(int.from_bytes(b'\x00\x00\x00\x00\x00\x00K\x03\xad\xbc\x0f6H\x98\xf3\xb9', 'big'))
